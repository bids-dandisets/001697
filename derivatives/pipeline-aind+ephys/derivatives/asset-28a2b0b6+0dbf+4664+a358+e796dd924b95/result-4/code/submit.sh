...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmpj8nom5au/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6+0dbf+4664+a358+e796dd924b95/result-4/logs/job-%j_slurm.log
#SBATCH --mem=1GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmpj8nom5au/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6+0dbf+4664+a358+e796dd924b95/result-4/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmpj8nom5au/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6+0dbf+4664+a358+e796dd924b95/result-4/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmpj8nom5au/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6+0dbf+4664+a358+e796dd924b95/result-4/logs/nextflow.log" \
...
echo "tmpj8nom5au" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
