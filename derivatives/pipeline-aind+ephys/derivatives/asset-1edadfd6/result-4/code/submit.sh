...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmp3o_xygd0/001697/derivatives/pipeline-aind+ephys/derivatives/asset-1edadfd6/result-4/logs/job-%j_slurm.log
#SBATCH --mem=16GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmp3o_xygd0/001697/derivatives/pipeline-aind+ephys/derivatives/asset-1edadfd6/result-4/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmp3o_xygd0/001697/derivatives/pipeline-aind+ephys/derivatives/asset-1edadfd6/result-4/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmp3o_xygd0/001697/derivatives/pipeline-aind+ephys/derivatives/asset-1edadfd6/result-4/logs/nextflow.log" \
...
echo "tmp3o_xygd0" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
