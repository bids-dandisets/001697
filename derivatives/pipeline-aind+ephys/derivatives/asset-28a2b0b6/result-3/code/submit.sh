...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmp1oz2mqj9/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6/result-3/logs/job-%j_slurm.log
#SBATCH --mem=1GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmp1oz2mqj9/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6/result-3/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmp1oz2mqj9/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6/result-3/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmp1oz2mqj9/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6/result-3/logs/nextflow.log" \
...
echo "tmp1oz2mqj9" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
