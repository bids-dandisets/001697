...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmpff2vl04b/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6/result-6/logs/job-%j_slurm.log
#SBATCH --mem=1GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmpff2vl04b/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6/result-6/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmpff2vl04b/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6/result-6/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmpff2vl04b/001697/derivatives/pipeline-aind+ephys/derivatives/asset-28a2b0b6/result-6/logs/nextflow.log" \
...
echo "tmpff2vl04b" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
