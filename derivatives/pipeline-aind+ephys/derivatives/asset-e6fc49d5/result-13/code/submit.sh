...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmpo0fr49ow/001697/derivatives/pipeline-aind+ephys/derivatives/asset-e6fc49d5/result-13/logs/job-%j_slurm.log
#SBATCH --mem=1GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmpo0fr49ow/001697/derivatives/pipeline-aind+ephys/derivatives/asset-e6fc49d5/result-13/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmpo0fr49ow/001697/derivatives/pipeline-aind+ephys/derivatives/asset-e6fc49d5/result-13/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmpo0fr49ow/001697/derivatives/pipeline-aind+ephys/derivatives/asset-e6fc49d5/result-13/logs/nextflow.log" \
...
echo "tmpo0fr49ow" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
