...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmpeusg_lg6/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-1/logs/job-%j_slurm.log
#SBATCH --mem=16GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmpeusg_lg6/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-1/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmpeusg_lg6/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-1/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmpeusg_lg6/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-1/logs/nextflow.log" \
...
echo "tmpeusg_lg6" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
