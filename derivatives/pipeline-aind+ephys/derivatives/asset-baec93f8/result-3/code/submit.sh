...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmpyp5cm03v/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-3/logs/job-%j_slurm.log
#SBATCH --mem=1GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmpyp5cm03v/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-3/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmpyp5cm03v/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-3/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmpyp5cm03v/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-3/logs/nextflow.log" \
...
echo "tmpyp5cm03v" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
