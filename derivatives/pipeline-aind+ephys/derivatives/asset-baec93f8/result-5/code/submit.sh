...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmp6zagcjv_/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-5/logs/job-%j_slurm.log
#SBATCH --mem=1GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmp6zagcjv_/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-5/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmp6zagcjv_/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-5/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmp6zagcjv_/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-5/logs/nextflow.log" \
...
echo "tmp6zagcjv_" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
