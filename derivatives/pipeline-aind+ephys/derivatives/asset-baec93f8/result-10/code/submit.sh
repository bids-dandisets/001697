...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmp31f_ht36/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-10/logs/job-%j_slurm.log
#SBATCH --mem=1GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmp31f_ht36/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-10/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmp31f_ht36/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-10/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmp31f_ht36/001697/derivatives/pipeline-aind+ephys/derivatives/asset-baec93f8/result-10/logs/nextflow.log" \
...
echo "tmp31f_ht36" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
