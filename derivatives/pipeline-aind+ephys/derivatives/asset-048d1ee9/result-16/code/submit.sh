...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmp61xlmoy1/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-16/logs/job-%j_slurm.log
#SBATCH --mem=1GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmp61xlmoy1/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-16/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmp61xlmoy1/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-16/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmp61xlmoy1/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-16/logs/nextflow.log" \
...
echo "tmp61xlmoy1" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
