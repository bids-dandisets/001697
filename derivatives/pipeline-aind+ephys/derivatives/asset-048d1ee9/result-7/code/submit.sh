...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmpae8p45ll/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-7/logs/job-%j_slurm.log
#SBATCH --mem=16GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmpae8p45ll/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-7/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmpae8p45ll/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-7/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmpae8p45ll/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-7/logs/nextflow.log" \
...
"tmpae8p45ll" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt