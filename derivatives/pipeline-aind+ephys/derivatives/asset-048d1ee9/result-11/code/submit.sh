...
#SBATCH --output=/orcd/data/dandi/001/dandi-compute/processing/tmphbs4h0uo/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-11/logs/job-%j_slurm.log
#SBATCH --mem=16GB
...
RESULTS_PATH="/orcd/data/dandi/001/dandi-compute/processing/tmphbs4h0uo/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-11/intermediate"
...
DATA_PATH="$DATA_PATH" RESULTS_PATH="$RESULTS_PATH" NXF_APPTAINER_CACHEDIR="$NXF_APPTAINER_CACHEDIR" nextflow \
    -C "/orcd/data/dandi/001/dandi-compute/processing/tmphbs4h0uo/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-11/code/mit_engaging.config" \
    -log "/orcd/data/dandi/001/dandi-compute/processing/tmphbs4h0uo/001697/derivatives/pipeline-aind+ephys/derivatives/asset-048d1ee9/result-11/logs/nextflow.log" \
...
echo "tmphbs4h0uo" >> /orcd/data/dandi/001/dandi-compute/processing/done.txt
